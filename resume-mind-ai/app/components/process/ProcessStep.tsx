...
export default function ProcessStep({ stepNumber, icon, title, description }: ProcessStepProps) {
  return (
    <div className="relative text-center">
      ...
      <h4 className="text-2xl font-bold text-white mb-4">{stepNumber}. {title}</h4>
