            ...
            <div className="absolute inset-0 flex items-center justify-center opacity-70">
              <div className="relative w-full h-full">
                ...
                <div className="absolute top-[30%] left-[25%]">
                  ...
                  <span className="absolute -top-5 left-1/2 -translate-x-1/2 text-[8px] text-primary font-medium whitespace-nowrap">
                    ML
                  </span>
                </div>
                ...
                <div className="absolute top-[35%] left-[70%]">
                  ...
                  <span className="absolute -top-5 left-1/2 -translate-x-1/2 text-[8px] text-blue-400 font-medium whitespace-nowrap">
                    Experience
                  </span>
                </div>
                ...
                <div className="absolute top-[70%] left-[30%]">
                  ...
                  <span className="absolute -top-5 left-1/2 -translate-x-1/2 text-[8px] text-emerald-400 font-medium whitespace-nowrap">
                    Education
                  </span>
                </div>
                ...
                <div className="absolute top-[65%] left-[75%]">
                  ...
                  <span className="absolute -top-5 left-1/2 -translate-x-1/2 text-[8px] text-orange-400 font-medium whitespace-nowrap">
                    Projects
                  </span>
                </div>
              ...
              <div className="grid grid-cols-3 gap-4 mb-4">
                ...
                <div className="glass-card p-4 rounded-xl border-l-4 border-l-primary hover:bg-slate-800/50 transition-colors">
                  ...
                  <div className="text-slate-400 text-[10px] mt-1">
                    Linked to 3 Professional Projects
                  </div>
                </div>
                ...
                <div className="glass-card p-4 rounded-xl border-l-4 border-l-blue-400 hover:bg-slate-800/50 transition-colors">
                  ...
                  <div className="text-white text-sm font-semibold">
                    Leadership Readiness: High
                  </div>
                  <div className="text-slate-400 text-[10px] mt-1">
                    Based on 5 management indicators
                  </div>
                </div>
